...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: '이름을 입력하세요.' }),
...
__decorate([
    (0, class_validator_1.IsString)(),
    (0, typeorm_1.Column)('varchar', { select: false, nullable: false }),
    (0, class_validator_1.IsNotEmpty)({ message: '비밀번호를 입력하세요.' }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.Column)('boolean', { select: false, default: false }),
